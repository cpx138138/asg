...
infjumpb.MouseButton1Click:Connect(function()
	...
	infjumpb.Text = "连跳" .. ((infjump and "(开)") or "")
        ...
        local function makecbringframe(name)
        	...
        	uncbringbtn.BackgroundColor3 = Color3.fromRGB(255, 215, 0)
        	...
        	uncbringbtn.Text = "X"
        	uncbringbtn.TextColor3 = Color3.fromRGB(255, 215, 0)
        	uncbringbtn.TextSize = 16.000
        	cbringplrname.Parent = plrcbringf
        	cbringplrname.BackgroundColor3 = Color3.fromRGB(30, 30, 30)
        ...
        cbringallbtn.TextColor3 = Color3.fromRGB(255, 215, 0)
